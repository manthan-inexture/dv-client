...
import { loaded, loading, cusLogin } from '../../redux/actions';
              ...
              <div className="row g-0">
                ...
                <div className="col-lg-6">
                  <div className="card-body p-md-5 text-black">
                    <h3 className="mb-5 text-uppercase">Customer Login</h3>
                    ...
                    <div className='text-center mt-1'>
                      <Link to='/customer/signup' className='text-decoration-none'>don't have an account</Link>
                    </div>
                  </div>
                </div>
              </div>
